...
class RemoveWhitespaceTests(TestCase):
    def test_ok(self):
        ...
        self.assertEqual(val, '{"movement_type": "I","medium_transport_type": "A","flight_type": "C","control_point_id": "12","control_point_name": "MEDELLIN (MDE), AEROPUERTO JOSE MARIA CORDOVA","flight_date_yyyy_mm_dd": "2023-12-22","flight_number": "973","route_code": "10036","route_name": "FORTDERDALE-MEDELLIN","route_company_code": "SPR","route_company_name": "SPIRIT AIRLINES","country_id": "249","country_name": "ESTADOS UNIDOS","origin_city_id": "15","origin_city_department": "1","origin_city_name": "DALLAS , ESTADOS UNIDOS DE AMERICA"}')
